...
@app.on_message(filters.regex("^دينا$") & filters.group & ~BANNED_USERS)
@AdminRightsCheck
...
@app.on_message(filters.group & filters.command(["اوامر دينا"],""))
